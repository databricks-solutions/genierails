...
3. If a tag value has no matching policy, you MUST add an `fgac_policy` entry for it — no exceptions. Every non-public tag assignment must be covered by a policy.
